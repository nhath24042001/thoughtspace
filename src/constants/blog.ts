...
export const BLOG_LIST: IBlog[] = [
  ...
  },
  {
    ...
    description:
      "A beginner-friendly guide to SSH and how to use it for secure remote connections",
    content:
  ...
  },
  {
    ...
    image:
      "https://miro.medium.com/v2/resize:fit:720/format:webp/0*vVsia7i4DvG_uGik.png",
