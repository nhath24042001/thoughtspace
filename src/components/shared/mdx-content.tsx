...
type Props<T extends keyof JSX.IntrinsicElements> = React.ComponentPropsWithoutRef<T>;

const mdxComponents = {
  h2: (props: Props<'h2'>) => <h2 className="text-2xl font-bold mt-5 mb-4" {...props} />,
  h3: (props: Props<'h3'>) => <h3 className="text-xl font-semibold mt-6 mb-2" {...props} />,
  p: (props: Props<'p'>) => <p className="text-gray-700 leading-relaxed mb-4" {...props} />,
